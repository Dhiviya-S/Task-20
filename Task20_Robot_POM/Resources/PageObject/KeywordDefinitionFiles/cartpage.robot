...
# cartpage.robot contains keywords for testing the cart functionality like verifying items in cart.
...
Verify Items In Cart
    ...
    # Checks if the collected items are equal to the expected list
    Lists Should Be Equal    ${list}    ${current_items}
    Log To Console   "Items in cart verified successfully: ${current_items}"
