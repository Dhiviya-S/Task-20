...
# loginpage.robot contains keywords for testing the login functionality of the SauceDemo website.
...
*** Keywords ***
# Keyword to login to the webpage
Login Into The Webpage
    ...
    ${URL} =    Get Location
    Log To Console    Inventory Page URL:${URL}
